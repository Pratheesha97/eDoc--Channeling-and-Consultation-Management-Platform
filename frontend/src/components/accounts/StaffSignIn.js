...
import Receptionist from "../guestUserMode/images/Receptionist.jpg";
...
const useStyles = makeStyles((theme) => ({
  ...
  image: {
    backgroundImage: `url(${Receptionist})`,
    maxWidth: "30%",
...
const StaffSignIn = (props) => {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    props.staffLogin(email, password);
  };
